    ...
    <div class="fixed inset-0 flex z-40">
      ...
      >
        ...
        <button
          ...
          class="w-6  p-1 my-1 rounded-r-lg text-white bg-gray-600 text-center focus:outline-none hover:bg-gray-500 transition-color duration-300"
        >
          <span
        ...
        <div
          ref="content"
          class="transition-all duration-700  overflow-hidden flex justify-center"
      ...
      <transition name="fade">
        ...
        <div
          v-if="dimmer && open"
          @click="toggle()"
          class="flex-1 bg-gray-700 bg-opacity-75 active:outline-none z-10"
        />
      </transition>
    </div>
