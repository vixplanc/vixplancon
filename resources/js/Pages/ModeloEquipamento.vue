...
// import formSchema from "@/Utils/Schemas/modelo";
import { useEquipmentType } from "@/utils/schemas/useEquipmentType.js";
import API from "../Services/api";
import { ref, reactive, onMounted } from "vue";
const { schema } = useEquipmentType()
const processing = ref(false);

const api = new API("api/modelos");
...
<template>
    ...
    <AppLayout title="Tipo de Equipamento">
        <template #header>
